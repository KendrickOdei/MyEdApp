...
const GraduationNews = () => {
    return(
      ...
      {/* Graduation summary */}
      <div className='mt-10 mb-4 ml-2 mr-2 shadow-2xl bg-sky-900 text-white'>
        <p>
        ...
        <p>
        Our Grade 6 graduates also took the spotlight, showcasing their hard work, dedication, and readiness for the next phase of their educational journey. These students have demonstrated exceptional academic achievements, leadership qualities, and a commitment to their studies that we know will serve them well in the future.
        </p>
